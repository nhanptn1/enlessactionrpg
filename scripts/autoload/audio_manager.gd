...
func _connect_signals() -> void:
	...
	SignalBus.player_ultimate_used.connect(func(): play_sfx("ultimate", 1.0))
...
func _build_streams() -> void:
	...
	_streams["dash"] = _make_tone(700.0, 0.1, 0.22, "square", true)
	_streams["ultimate"] = _make_arpeggio([392.0, 523.0, 659.0, 784.0, 1047.0], 0.07, 0.3)
